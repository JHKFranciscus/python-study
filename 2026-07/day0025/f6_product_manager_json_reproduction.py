...
#region
#3번
# back = create_product_from_dict(d.to_dict())
# print(type(back), back.to_dict() == d.to_dict())

# back2 = create_product_from_dict({"type": "product", "name": "마우스", "price": 15000})
# print(type(back2), back2.to_dict())
#endregion
#region
#4번
# save_products([p, d], "managed_products.json")
# loaded = load_products("managed_products.json")
# print(loaded)
# print(type(loaded[0]), type(loaded[1]))
# print(load_products("없는파일.json"))
#endregion
